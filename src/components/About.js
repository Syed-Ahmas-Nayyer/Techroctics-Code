...
const About = () => {
  return (
    <>
      <div className="container myclass" style={{ paddingTop: '60px', marginBottom:"50px" }}>
        <div className="row">
          <div className="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 abt-left aos-init aos-animate" data-aos="zoom-in" data-aos-duration="1000">
            <h2 className="heading" style={{ paddingLeft: "17px" }} >
              About <b>Techroctics Lab</b>
            </h2>
            <br />
            <p className="text" style={{ paddingLeft: "17px" }}>
              From humble beginnings in the slums of Karachi to becoming a
              multimillionaire, Sunny Ali is on a mission to transform the
              digital landscape of Pakistan through digital skills, personal
              development and capacity building. His vision is to empowerthe
              people of Pakistan to achieve self-sufficiency through  ecommerce
              and digital skills, especially through Amazon’s FBA (Fulfilment by
              Amazon) model.
            </p>
            <br />
            <a href="https://ec.com.pk/about-us" className="btn btn-primary mx-3"   >
              Learn More
              <svg
                width="12"
                height="12"
          ...
          <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
            <img
              ...
              data-src="https://ec.com.pk/assets/img/about.webp"
              width="350"
              height="348"
              alt=""
              data-aos="zoom-in"
              data-aos-duration="1000"
              src="https://ec.com.pk/assets/img/about.webp"
            />
          </div>
        </div>
      </div>
